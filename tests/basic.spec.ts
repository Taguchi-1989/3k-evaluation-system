...
test.describe('3K評価アプリケーション - 基本動作テスト', () => {
  ...
  test('評価ページ（精神因子）にアクセスできる', async ({ page }) => {
    await page.goto('http://localhost:3000/evaluation/mental')
    await page.waitForLoadState('networkidle')
  ...
  test('評価ページ（環境因子）にアクセスできる', async ({ page }) => {
    await page.goto('http://localhost:3000/evaluation/environmental')
    await page.waitForLoadState('networkidle')
  ...
  test('評価ページ（危険因子）にアクセスできる', async ({ page }) => {
    await page.goto('http://localhost:3000/evaluation/hazard')
    await page.waitForLoadState('networkidle')
  ...
  test('評価ページ（作業時間）にアクセスできる', async ({ page }) => {
    await page.goto('http://localhost:3000/evaluation/worktime')
    await page.waitForLoadState('networkidle')
